...
{
    public static class JpegConst
    {

        public static int[] naturalOrder = new int[] { 0, 1, 8, 16, 9, 2, 3, 10, 17, 24, 32, 25, 18, 11, 4, 5, 12,
        19, 26, 33, 40, 48, 41, 34, 27, 20, 13, 6, 7, 14, 21, 28, 35, 42, 49, 56, 57, 50, 43, 36, 29, 22, 15, 23,
        30, 37, 44, 51, 58, 59, 52, 45, 38, 31, 39, 46, 53, 60, 61, 54, 47, 55, 62, 63 };

        public static VLC YDC_DEFAULT;
        public static VLC YAC_DEFAULT;
        public static VLC CDC_DEFAULT;
        public static VLC CAC_DEFAULT;
        static JpegConst()
        {
        ...
        public static int SOF0 = 0xc0;
        /** Start Of Frame - Extended sequential DCT */
        public static int SOF1 = 0xc1;
        /** Start Of Frame - Progressive DCT */
        public static int SOF2 = 0xc2;
        /** Start Of Frame - Lossless (sequential) */
        public static int SOF3 = 0xc3;
        /** Huffman table specification - Define Huffman table(s) */
        public static int DHT = 0xc4;
        /** Define quantization table(s) */
        public static int DQT = 0xdb;
        /** Start of scan */
        public static int SOS = 0xda;
        /** End of image - standalone marker */
        public static int EOI = 0xd9;
        /** Start of image - standalone marker */
        public static int SOI = 0xd8;
        /** Reserved for application segments */
        public static int APP0 = 0xe0;
        /** Reserved for application segments */
        public static int APP1 = 0xe1;
        /** Reserved for application segments */
        public static int APP2 = 0xe2;
        /** Reserved for application segments */
        public static int APP3 = 0xe3;
        /** Reserved for application segments */
        public static int APP4 = 0xe4;
        /** Reserved for application segments */
        public static int APP5 = 0xe5;
        /** Reserved for application segments */
        public static int APP6 = 0xe6;
        /** Reserved for application segments */
        public static int APP7 = 0xe7;
        /** Reserved for application segments */
        public static int APP8 = 0xe8;
        /** Reserved for application segments */
        public static int APP9 = 0xe9;
        /** Reserved for application segments */
        public static int APPA = 0xea;
        /** Reserved for application segments */
        public static int APPB = 0xeb;
        /** Reserved for application segments */
        public static int APPC = 0xec;
        /** Reserved for application segments */
        public static int APPD = 0xed;
        /** Reserved for application segments */
        public static int APPE = 0xee;
        /** Reserved for application segments */
        public static int APPF = 0xef;
        /** Restart with modulo 8 count 0 */
        public static int RST0 = 0xd0;
        /** Restart with modulo 8 count 1 */
        public static int RST1 = 0xd1;
        /** Restart with modulo 8 count 2 */
        public static int RST2 = 0xd2;
        /** Restart with modulo 8 count 3 */
        public static int RST3 = 0xd3;
        /** Restart with modulo 8 count 4 */
        public static int RST4 = 0xd4;
        /** Restart with modulo 8 count 5 */
        public static int RST5 = 0xd5;
        /** Restart with modulo 8 count 6 */
        public static int RST6 = 0xd6;
        /** Restart with modulo 8 count 7 */
        public static int RST7 = 0xd7;

        public static int COM = 0xfe;
        /** Define restart interval marker */
        public static int DRI = 0xdd;
    }
}
