...
namespace nVideo.Codecs.ProRes
{
    public class ProresConsts
    {
        ...
        public static Codebook[] dcCodebooks = new Codebook[] {
            new Codebook(0, 1, 0),
            new Codebook(1, 2, 0),
            new Codebook(1, 2, 0),
            new Codebook(2, 3, 1),
        ...
        public static Codebook[] runCodebooks = new Codebook[] {
            new Codebook(0, 1, 2),
            new Codebook(0, 1, 2),
            new Codebook(0, 1, 1),
            new Codebook(0, 1, 1),
        ...
        public static Codebook[] levCodebooks = new Codebook[] {
            new Codebook(0, 1, 0),
            new Codebook(0, 2, 2),
            new Codebook(0, 1, 1),
            new Codebook(0, 1, 2),
        ...
        public static int[] QMAT_LUMA_APCH = new int[] { 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
            4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4, 4, 4, 4, 4, 4, 5, 5, 4, 4, 4, 4, 4, 5, 5, 6, 4, 4, 4, 4, 5, 5, 6, 7,
            4, 4, 4, 4, 5, 6, 7, 7 };
        public static int[] QMAT_CHROMA_APCH = new int[] { 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
            4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4, 4, 4, 4, 4, 4, 5, 5, 4, 4, 4, 4, 4, 5, 5, 6, 4, 4, 4, 4, 5, 5, 6,
            7, 4, 4, 4, 4, 5, 6, 7, 7 };

        public static int[] QMAT_LUMA_APCO = new int[] { 4, 7, 9, 11, 13, 14, 15, 63, 7, 7, 11, 12, 14, 15, 63, 63,
        ...
        public static int[] QMAT_CHROMA_APCO = new int[] { 4, 7, 9, 11, 13, 14, 63, 63, 7, 7, 11, 12, 14, 63, 63, 63,
            9, 11, 13, 14, 63, 63, 63, 63, 11, 11, 13, 14, 63, 63, 63, 63, 11, 13, 14, 63, 63, 63, 63, 63, 13, 14, 63,
            63, 63, 63, 63, 63, 13, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63 };

        public static int[] QMAT_LUMA_APCN = new int[] { 4, 4, 5, 5, 6, 7, 7, 9, 4, 4, 5, 6, 7, 7, 9, 9, 5, 5, 6, 7,
            7, 9, 9, 10, 5, 5, 6, 7, 7, 9, 9, 10, 5, 6, 7, 7, 8, 9, 10, 12, 6, 7, 7, 8, 9, 10, 12, 15, 6, 7, 7, 9, 10,
            11, 14, 17, 7, 7, 9, 10, 11, 14, 17, 21 };

        public static int[] QMAT_CHROMA_APCN = new int[] { 4, 4, 5, 5, 6, 7, 7, 9, 4, 4, 5, 6, 7, 7, 9, 9, 5, 5, 6,
            7, 7, 9, 9, 10, 5, 5, 6, 7, 7, 9, 9, 10, 5, 6, 7, 7, 8, 9, 10, 12, 6, 7, 7, 8, 9, 10, 12, 15, 6, 7, 7, 9,
            10, 11, 14, 17, 7, 7, 9, 10, 11, 14, 17, 21 };

        public static int[] QMAT_LUMA_APCS = new int[] { 4, 5, 6, 7, 9, 11, 13, 15, 5, 5, 7, 8, 11, 13, 15, 17, 6, 7,
        ...
        public static int[] QMAT_CHROMA_APCS = new int[] { 4, 5, 6, 7, 9, 11, 13, 15, 5, 5, 7, 8, 11, 13, 15, 17, 6,
        ...
        public class FrameHeader
        {
            ...
            public FrameHeader(int frameSize, int width, int height, int frameType, bool topFieldFirst, int[] scan, int[] qMatLuma,
