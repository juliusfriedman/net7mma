...
namespace nVideo.Codecs.H264
{
    public class BlockInterpolator
    {
         ...
         */
        public static void getBlockLuma(Picture pic, Picture outp, int off, int x, int y, int w, int h)
        {
            int xInd = x & 0x3;
            int yInd = y & 0x3;
            ...
            {
                unsafes[(yInd << 2) + xInd](pic.getData()[0], pic.getWidth(), pic.getHeight(), outp.getPlaneData(0),
                        off, outp.getPlaneWidth(0), xFp, yFp, w, h);
            }
            else
            {
                safe[(yInd << 2) + xInd](pic.getData()[0], pic.getWidth(), pic.getHeight(), outp.getPlaneData(0),
                        off, outp.getPlaneWidth(0), xFp, yFp, w, h);
            }
        }
                ...
                int blkH)
        {
            ...
            {
                System.Array.Copy(pic, off, blk, blkOff, blkW);
                off += picW;
                blkOff += blkStride;
            }
        }
        ...
        private delegate void LumaInterpolator(int[] pels, int picW, int imgH, int[] blk, int blkOff, int blkStride, int x, int y, int blkW,
                    int blkH);

        private static LumaInterpolator[] safe = new LumaInterpolator[] {

        new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma00(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma10(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma20(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma30(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
        new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma01(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma11(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma02(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma12(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
        new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma02(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma22(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma22(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma32(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma03(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma13(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma23(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
    new LumaInterpolator((pels, picW, i, blk, blkOff, blkStride, x, y, blkW, blkH)=>{getLuma33(pels, picW, blk, blkOff, blkStride, x, y, blkW, blkH);}),
        };

        private static LumaInterpolator[] unsafes = new LumaInterpolator[] {
    new LumaInterpolator(getLuma00Unsafe),
    new LumaInterpolator(getLuma10Unsafe),
    new LumaInterpolator(getLuma20Unsafe),
    new LumaInterpolator(getLuma30Unsafe),
    new LumaInterpolator(getLuma01Unsafe),
    new LumaInterpolator(getLuma11Unsafe),
    new LumaInterpolator(getLuma21Unsafe),
    new LumaInterpolator(getLuma32Unsafe),
    new LumaInterpolator(getLuma02Unsafe),
    new LumaInterpolator(getLuma12Unsafe),
    new LumaInterpolator(getLuma22Unsafe),
    new LumaInterpolator(getLuma32Unsafe),
    new LumaInterpolator(getLuma03Unsafe),
    new LumaInterpolator(getLuma03Unsafe),
    new LumaInterpolator(getLuma31Unsafe),
    new LumaInterpolator(getLuma32Unsafe),
    new LumaInterpolator(getLuma33Unsafe)
};
    }
}
