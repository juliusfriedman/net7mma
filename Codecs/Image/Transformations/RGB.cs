                        ...
                        for (int c = 0, ce = src.ImageFormat.Components.Length; c < ce; ++c)
                        {
                            ...
                            switch (mc.Id)
                            {
                                ...
                                case Media.Codecs.Image.ImageFormat.RedChannelId:
                                    {
                                        ...
                                        r = (byte)(src.ByteOrder == Common.Binary.ByteOrder.Big ? Common.Binary.ReadBitsMSB(src.Data.Array, ref bitOffset, mc.Size) : Common.Binary.ReadBitsLSB(src.Data.Array, ref bitOffset, mc.Size));
                                ...
                                case Media.Codecs.Image.ImageFormat.GreenChannelId:
                                    {
                                        //Read the component and store the result
                                        g = (byte)(src.ByteOrder == Common.Binary.ByteOrder.Big ? Common.Binary.ReadBitsMSB(src.Data.Array, ref bitOffset, mc.Size) : Common.Binary.ReadBitsLSB(src.Data.Array, ref bitOffset, mc.Size));
                                ...
                                case Media.Codecs.Image.ImageFormat.BlueChannelId:
                                    {
                                        //Read the component and store the result
                                        b = (byte)(src.ByteOrder == Common.Binary.ByteOrder.Big ? Common.Binary.ReadBitsMSB(src.Data.Array, ref bitOffset, mc.Size) : Common.Binary.ReadBitsLSB(src.Data.Array, ref bitOffset, mc.Size));
                ...
                case Codec.DataLayout.Packed:
                    {
                        ...
                        for (int c = 0, ce = src.ImageFormat.Components.Length; c < ce; ++c)
                        {
                            ...
                            switch (mc.Id)
                            {
                                ...
                                default:
                                    {
                                        Common.Binary.ReadBitsMSB(src.Data.Array, ref bitOffset, mc.Size);
                                        continue;
                                    }
                                case Media.Codecs.Image.ImageFormat.RedChannelId:
                                    {
