...
namespace Media.Rtsp.Server.Streams
{
    ...
    /// </summary>
    public class RiffFileSource : FileSourceStream
    {
        #region Statics
        ...
        public RiffFileSource(string name, Uri source)
            : base(name, source) { }
        ...
        {
            foreach (Container.ContainerElement trackBoxes in ReadElement("RIFF/LIST/*"))
            {
